...
getProxyAgent_fn = async function() {
  __privateGet(this, _proxyAgent) || __privateSet(this, _proxyAgent, (await import("./index-DUkvNAcn.js").then((n) => n.i)).HttpsProxyAgent);
  return __privateGet(this, _proxyAgent);
};
getFetch_fn = async function() {
  const hasWindow = typeof window !== "undefined" && !!window;
  __privateGet(this, _fetch) || __privateSet(this, _fetch, hasWindow ? window.fetch : (await import("./index-Bq1AFfvh.js")).default);
...
var fs$2 = _interopRequireWildcard(require$$0$2);
var _gaxios = src$3;
...
async function loginWithGoogle() {
  const credentialsPath = require$$2$1.join(
    __dirname,
    "../config/client_secret.json"
  );
  const credentials = JSON.parse(
    require$$0$2.readFileSync(credentialsPath, "utf-8")
  );
