...
getProxyAgent_fn = async function() {
  __privateGet(this, _proxyAgent) || __privateSet(this, _proxyAgent, (await import("./index-DiAq3H5d.js").then((n) => n.i)).HttpsProxyAgent);
  return __privateGet(this, _proxyAgent);
};
getFetch_fn = async function() {
  const hasWindow = typeof window !== "undefined" && !!window;
  __privateGet(this, _fetch) || __privateSet(this, _fetch, hasWindow ? window.fetch : (await import("./index-D7mUvGPV.js")).default);
...
async function getRootWithContents() {
  try {
    ...
    const items = await listFolderContents(client, rootId);
    const servers = items.filter(
...
ipcMain.handle("get-server-path", async (__dirname2, serverId) => {
